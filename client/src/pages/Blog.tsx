...
const articles = [
  ...
  },
  {
    ...
    readTime: "6 минут",
    img: `${CDN}/ru-industrial-ventilation_4939c0aa.jpg`,
    href: "/blog/ventilyaciya-pod-klyuch",
    excerpt: "Монтаж вентиляции под ключ — полный цикл от проектирования до сдачи. Рассказываем об этапах, сроках и стоимости работ.",
  },
  {
    ...
    readTime: "7 минут",
    img: `${CDN}/ru-hvac-production_2fc3fdd7.jpg`,
    href: "/blog/proektirovanie-ventilyacii",
    excerpt: "Проектирование системы вентиляции — обязательный этап перед монтажом. Нормативная база, этапы и стоимость разработки проекта.",
  },
  {
    ...
    readTime: "5 минут",
    img: `${CDN}/equip-ventilation_25987b56.jpg`,
    href: "/blog/obsluzhivanie-ventilyacii",
    excerpt: "Регулярное техническое обслуживание вентиляционных систем — залог надёжной работы. Периодичность, состав работ и стоимость сервисного контракта.",
  },
  {
    ...
    readTime: "8 минут",
    img: `${CDN}/equip-ac_decafa77.webp`,
    href: "/blog/vrf-sistemy",
    excerpt: "VRF и VRV системы — мультизональное кондиционирование для офисов, гостиниц и торговых центров. Преимущества, производители, стоимость монтажа.",
  },
  {
    ...
    readTime: "7 минут",
    img: `${CDN}/equip-ac_decafa77.webp`,
    href: "/blog/chillery-i-fankojly",
    excerpt: "Система чиллер-фанкойл — центральное кондиционирование для объектов от 1000 м². Принцип работы, преимущества и виды чиллеров.",
  },
  {
    ...
    readTime: "6 минут",
    img: `${CDN}/ru-industrial-ventilation_4939c0aa.jpg`,
    href: "/blog/dymoudalenie-pod-klyuch",
    excerpt: "Система дымоудаления — обязательный элемент противопожарной защиты. Нормативные требования, состав системы и лицензия МЧС.",
  },
  {
    ...
    readTime: "8 минут",
    img: `${CDN}/equip-heating_49ba3696.jpg`,
    href: "/blog/teplovye-nasosy",
    excerpt: "Тепловой насос — эффективность в 3–5 раз выше электрических нагревателей. Виды, принцип работы и экономия на отоплении.",
  },
  {
    ...
    readTime: "6 минут",
    img: `${CDN}/equip-ventilation_25987b56.jpg`,
    href: "/blog/energoeffektivnost-ventilyacii",
    excerpt: "Рекуперация, частотные преобразователи, CO2-управление — как снизить энергопотребление вентиляции на 30–60%.",
  },
  {
    ...
    readTime: "7 минут",
    img: `${CDN}/equip-ac_decafa77.webp`,
    href: "/blog/montazh-kondicionirovaniya",
    excerpt: "Сплит-системы, мульти-сплит, VRF, чиллер-фанкойл — виды систем кондиционирования, стоимость монтажа и этапы работ.",
  },
  {
    ...
    readTime: "7 минут",
    img: `${CDN}/ru-industrial-ventilation_4939c0aa.jpg`,
    href: "/blog/ventilyaciya-sklada",
    excerpt: "Нормы воздухообмена для складов по категориям пожарной опасности. Особенности проектирования и оборудование для складских комплексов.",
  },
  {
    ...
    readTime: "6 минут",
    img: `${CDN}/equip-ac_decafa77.webp`,
    href: "/blog/kondicionirovanie-pod-klyuch",
    excerpt: "Монтаж кондиционирования под ключ: от обследования объекта до пусконаладки и сервисного обслуживания. 15 лет опыта, 25 бригад.",
  },
  {
    ...
    readTime: "8 минут",
    img: `${CDN}/ru-industrial-ventilation_4939c0aa.jpg`,
    href: "/blog/ventilyaciya-promyshlennyh-predpriyatij",
    excerpt: "Промышленная вентиляция: общеобменная, местная вытяжная, аварийная. Нормативные требования и особенности проектирования для заводов и цехов.",
  },
  {
    ...
    readTime: "7 минут",
    img: `${CDN}/equip-electrical_a91c8ffb.jpg`,
    href: "/blog/avtomatika-ventilyacii",
    excerpt: "Системы автоматики для вентиляции и кондиционирования: контроллеры, интеграция с BMS, управление по CO2, дистанционный мониторинг.",
  },
];
