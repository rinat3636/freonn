        ...
        <AnimatePresence>
          {showTop && (
            <motion.button
              ...
              className="w-14 h-14 bg-[#2D3092] text-white flex items-center justify-center shadow-md hover:bg-[#0F1340] transition-colors hover:scale-110 active:scale-95 rounded-full"
              title="Наверх"
            >
              <ArrowUp size={22} />
            </motion.button>
